function citper_count=p383sumcitper(citn_n,citn_e)
%gera o arquivo "citper" com as totalização das citações entre periódicos de um ano
%
%parâmetros de entrada:
    %citn_n: lista de citações NORMAIS dos artigos deste período
    %citn_e: lista de citações ESTRATEGICAS dos artigos deste período
...
%junta as listas de citações NORMAIS e ESTRATÉGICAS do ano em uma lista apenas
citn=[citn_n;citn_e];
